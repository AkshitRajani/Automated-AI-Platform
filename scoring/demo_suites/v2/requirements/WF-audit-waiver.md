...
**Unit:** `WF-audit-waiver`
**Domain:** DCFO late fee and payment operations

## Overview
Specifies behavioural expectations for audit on waiver within DCFO late-fee operations.
...
- The system shall write an audit entry for every approved waiver including reason text

## Acceptance Criteria
- AC-1: Verify that the system write an audit entry for every approved waiver including reason text
