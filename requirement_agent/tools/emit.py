...
def reset_emit(workspace_dir: str, app_id: str, facts=None,
               source_available: bool = False) -> None:
    ...
    global _workspace, _app_id, _facts, _source_available, _builders, _finished, _skipped
...
@tool
def write_section(unit_id: str, section: str, content: str) -> str:
...
def _norm(name: str) -> str:
    from requirement_agent.schemas import section_key
