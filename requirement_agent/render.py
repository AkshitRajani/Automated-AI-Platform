...
into the nine-section markdown document. Also exposes ``load_doc`` (parse + validate one
...
from requirement_agent.schemas import (CANONICAL_SECTIONS, RequirementDoc, section_key)
...
def render_markdown(doc: RequirementDoc) -> str:
    """The nine-section requirement document for one unit, as markdown. Renders the nine
